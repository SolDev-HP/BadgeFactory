...
export default function Menu({ }) {
    ...
    <>
        ...
        <div className="flex flex-col gap-1">
            ...
            <MenuItem menu_icon={"contact_icon"} menu_link={"/contact"} menu_text={"Contact Us"} />
            <MenuItem menu_icon={"contact_icon"} menu_link={"/contracts"} menu_text={"Deploments"} />
        </div>
        {/**  This is for social links*/}
        <div className="flex flex-col gap-1">
            <MenuItem menu_icon={"bf_x_icon"} menu_link={"#"} menu_text={"Twitter ->"} />
            <MenuItem menu_icon={"bf_discord_icon"} menu_link={"#"} menu_text={"Discord ->"} />
            <MenuItem menu_icon={"bf_tg_icon"} menu_link={"#"} menu_text={"Telegram ->"} />
            <MenuItem menu_icon={"bf_docs_icon"} menu_link={"#"} menu_text={"Docs & Github ->"} />
        </div>
        </div>
    </>    
    );
